...
if (isset($_POST['modificado'])){
    if(isset($_POST['id_loteA']) && ($_POST['nombre_loteA'])){
		...
		if(mysqli_num_rows($verificar_loteA)<1){
			header("location:../../../Views/Html/Verifications/VerificationsProducts/no_existe_modificar_lote_alimento.html");
			exit();
		}
        ...
        if ($respuesta) {{}
            header("location:../../../Views/Html/Verifications/VerificationsProducts/correcto_modificar_lote_alimento.html");
        }else{
