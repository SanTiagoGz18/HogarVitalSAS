...
if (isset($_POST['eliminar'])){
    if(isset($_POST['id_usuario'])){
		...
		if(mysqli_num_rows($verificar_documento)<1){
			header("location:../../../Views/Html/Verifications/VerificationsEmployee/no_existe.html");
			exit();
		}
        ...
        if ($respuesta) {{}
            header("location:../../../Views/Html/Verifications/VerificationsEmployee/correcto_eliminar_personal.html");
        }else{
