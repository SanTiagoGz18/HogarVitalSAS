...
if (isset($_POST['enviar'])){
	if(isset($_POST['nombre_loteA'])){	
		...
		if(mysqli_num_rows($verificar_lote)>0){
			header("location:../../../Views/Html/Verifications/repetido_lote_alimento.html");
			exit();
		}
		...
		if ($respuesta) {
			header('Location:../../../Views/Html/Verifications/VerificationsProducts/correcto_registro_lote_alimento.html');
		}
	}
