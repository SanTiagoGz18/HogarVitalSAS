...
if (isset($_POST['enviar'])){
	if(isset($_POST['id_producto']) && (isset($_POST['cantidad_producto']))){
		...
		if($_REQUEST['categoria'] == 'alimento' && $_REQUEST['loteA'] == 'no'){
			header("location:../../../Views/Html/Verifications/VerificationsProducts/agregue_loteA.html");
			exit();
		}
		...
		if ($respuesta) {
			...
			header("location:../../../Views/Html/Verifications/VerificationsProducts/correcto_productos.html");
		}else{
			echo "mal";
		}
	}
