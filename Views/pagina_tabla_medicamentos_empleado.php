...
<tbody>
<?php
$select="SELECT * FROM productos WHERE id_tipo_producto='2'";
...
while($fila=mysqli_fetch_array($resultado)){?>
	<tr>
		...
		<td><a href="../Views/Html/pagina_productos_detalle.html"><img src="imagenes/detalle_empleado.png" alt="detalles" class="boton"></a></td>
		</td>
	</tr>
