...
if(isset($_POST['modificar'])){
    ...
    $resultado=mysqli_query($conexion, "SELECT * FROM proveedor inner join cargo on usuarios.cargo_id=cargo.id_cargo where id_usuario='$id_usuario'");
