...
<form action="../Controller/codigo_registro_productos_empleado.php" method="post">
	...
	<a href="../Views/Html/pagina_inicial_producto_empleado.html"><input type="submit" value="Volver" class="boton2"></a>
</div>
</body>
</html>