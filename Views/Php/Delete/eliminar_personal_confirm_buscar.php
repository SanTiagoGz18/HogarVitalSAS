...
<html>
  ...
  <body>
    ...
    <div class="contenedor">
      ...
      <form action="../../../Controller/Delete/Admin/eliminar_personal_buscar.php" method="post">
        ...
        <a href="../Search/Admin/pagina_inicial_buscador_empleado.php"><input type="submit" value="Volver" class="boton2"></a>
    </div>
  </body>
</html>