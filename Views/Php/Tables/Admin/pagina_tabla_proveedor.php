...
<body>
	<div>
		...
		<a href="../../Registers/Proveedor/codigo_registro_proveedor.php"><input type="submit" id="boton" value="Agregar Proveedor"></a> 
		
		<img src="../../../imagenes/editar_proveedor.png" class="imgp1">
		<a href="../../Update/Admin/Confirms/modificar_proveedor_confirm.php"><input type="submit" id="boton3" value="Modificar Proveedor"></a>

		<img src="../../../imagenes/eliminar_proveedor.png" class="imgmarca">
		<a href="../../Delete/eliminar_proveedor_confirm.php"><input type="submit" id="boton2" value="Eliminar Proveedor"></a>
	</div>
	<div class="icono">
