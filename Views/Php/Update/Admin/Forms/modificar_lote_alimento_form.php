...
if(isset($_POST['modificar'])){
	...
	if(mysqli_num_rows($verificar_id_loteA)<1){
		header("location:../../../../Html/Verifications/VerificationsProducts/no_existe_modificar_lote_alimento.html");
		exit();
	}
...
<div class="perfilP">
	<div class="infoP"> 
		<div class="info2P">
		<form action="../../../../../Controller/Update/Admin/modificar_lote_alimento.php" method="post">
