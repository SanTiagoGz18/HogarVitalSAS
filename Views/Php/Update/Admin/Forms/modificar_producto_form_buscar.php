...
<div class="perfil">
	<div class="info"> 
		<div class="info2">
		<form action="../../../../../Controller/Update/Admin/modificar_productos_buscar.php" method="post">
            <br>
            <br>
			...
			<a href="../../../Search/Admin/pagina_inicial_buscador_producto.php"><input type="submit" value="Cancelar" class="boton3"></a>
		</div>
	</div>
</div>
</body>
