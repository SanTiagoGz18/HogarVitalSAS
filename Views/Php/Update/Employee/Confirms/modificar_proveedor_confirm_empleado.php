...
<html>
  ...
  <body>
    ...
    <div class="contenedor">
      ...
      <form action="../Forms/modificar_proveedor_form_empleado.php" method="post">
        ...
        <br>
        <a href="../../../Tables/Employee/pagina_tabla_proveedor_empleado.php"><input type="submit" value="Volver" class="boton2"></a>
    </div>
  </body>
</html>