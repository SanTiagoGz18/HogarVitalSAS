...
<html>
  ...
  <body>
    ...
    <div class="contenedor">
      ...
      <form action="../Forms/modificar_lote_alimento_form_empleado.php" method="post">
        ...
        <br>
        <a href="../../../Tables/Employee/pagina_tabla_lote_alimento_empleado.php"><input type="submit" value="Volver" class="boton2"></a>
    </div>
  </body>
</html>