...
if(isset($_POST['modificar'])){
	...
	if(mysqli_num_rows($verificar_id_marca)<1){
		header("location:../../../../Html/Verifications/VerificationsProducts/Employee/no_existe_modificar_marca_empleado.html");
		exit();
	}
...
<div class="perfilP">
	<div class="infoP"> 
		<div class="info2P">
		<form action="../../../../../Controller/Update/Employee /modificar_marca_empleado.php" method="post">
			...
			<a href="../../../Tables/Employee/pagina_tabla_marca_empleado.php"><input type="submit" value="Cancelar" class="boton3P"></a>
		</div>
	</div>
</div>
</body>
