...
if(isset($_POST['modificar'])){
    ...
    $verificar_codigo=mysqli_query($conexion, "SELECT * FROM productos WHERE id_producto='$id_producto'");
		...
		if(mysqli_num_rows($verificar_codigo)<1){
			header("location:../../../../Html/Verifications/VerificationsProducts/Employee/no_existe_modificar_producto_empleado.html");
			exit();
		}
...
<div class="perfil">
	<div class="info"> 
		<div class="info2">
		<form action="../../../../../Controller/Update/Employee/modificar_productos_empleado.php" method="post">
            <br>
            <br>
			...
			<a href="../../../pagina_inicial_producto_empleado.php"><input type="submit" value="Cancelar" class="boton3"></a>
		</div>
	</div>
</div>
</body>
