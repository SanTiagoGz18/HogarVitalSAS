...
<body>
	...
	<form action="pagina_inicial_buscador_producto_empleado.php" method="post">
		<div class="contenido">
...
if(isset($_POST['busqueda'])){
	...
	while($fila=mysqli_fetch_array($resultado)){?>
		...
		<tr>
			...
			<td><a href="../../../Html/pagina_modificar_eliminar_buscador_productos_empleado.html"><img src="../../../imagenes/detalles.png" alt="detalles" class="boton"></a></td>
		</tr>
	</div>
	</div>
<?php }} ?>
