...
<form action="../../../../Controller/Create/Admin/codigo_registro_lote_alimento.php" method="post">
...
<center><a href="../../../Php/Tables/Admin/pagina_tabla_lote_alimento.php"><input type="submit" value="Volver"  name="volver "class="boton2" style="margin-top:-6%"></a></center>
</div>
</body>
</html>