...
<form action="../../../../../Controller/Create/Employee/registro_marca_empleado.php" method="post">
...
<center><a href="../../../../Php/Tables/Employee/pagina_tabla_marca_empleado.php"><input type="submit" value="Volver"  name="volver "class="boton2" style="margin-top:-6%"></a></center>
</div>
</body>
</html>