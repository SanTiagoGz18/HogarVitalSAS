...
<form action="../../../../Controller/Create/Admin/registro_proveedor.php" method="post">
...
<center><a href="../../Tables/Admin/pagina_tabla_proveedor.php"><input type="submit" value="Volver"  name="volver "class="boton2" style="margin-top:-6%"></a></center>
</div>
</body>
</html>