...
<form action="../../../../../Controller/Create/Employee/registro_proveedor_empleado.php" method="post">
...
<center><a href="../../../Tables/Employee/pagina_tabla_proveedor_empleado.php"><input type="submit" value="Volver"  name="volver "class="boton2" style="margin-top:-6%"></a></center>
</div>
</body>
</html>