...
<div class="perfil1">
	<div class="info">
		<div class="info2">
		<form action="../Controller/actualizar_perfil_tabla_empleado.php" method="post">
			...
			<a href="../Views/pagina_perfil_tabla_empleado.php"><input type="submit" value="Cancelar" class="boton3"></a>
		</div>
	</div>
</div>
</body>
